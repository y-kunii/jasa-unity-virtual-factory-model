...
{
    public class ButtonNotificationController : MonoBehaviour, IRobotPartsController, IRobotPartsConfig
    {
...
//#endif
#if false
                this.pdu_writer = this.pdu_io.GetWriter(pdu_reader_name);
